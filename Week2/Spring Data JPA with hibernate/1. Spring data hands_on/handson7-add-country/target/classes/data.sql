-- Hands on 5: full country reference data (matches the hands-on doc's population script,
-- column names adapted to the Country entity's code/name columns from Hands on 1).
delete from country;
...
insert into country (code, name) values ('BL', 'Saint Barthelemy');
